...
## 1. Form Oluşturma
- Form oluşturmak için öncelikle "Formlar" modülüne gidin.
- "Yeni Form" butonuna tıklayın.
- Açılan sayfada formunuz için gerekli bilgileri girin:
    - **Form Adı:** Formunuzun adını girin.
    - **Form Tipi:** Formunuzun tipini seçin (örneğin: anket, sınav).
    - **Puan Hesaplama Tipi:** Formunuzdaki soruların puanlarının nasıl hesaplanacağını seçin (katsayı veya yüzdelik).
    - **Bağlı Olduğu Kurs:** Formunuzun hangi kursa bağlı olduğunu seçin.
    - **Puan Şablonu:** Formunuzdaki soruların puanlarının nasıl dağıtılacağını belirleyen şablonu seçin.
    - **Başlangıç Tarihi:** Formunuzun ne zaman açılacağını belirleyin.
    - **Bitiş Tarihi:** Formunuzun ne zaman kapanacağını belirleyin.
- "Sorular" bölümünde formunuza sorular ekleyebilirsiniz. Her soru için soru metnini, cevap seçeneklerini ve doğru cevabı belirleyebilirsiniz.
- Tüm bilgileri girdikten sonra "Kaydet" butonuna tıklayarak formunuzu oluşturabilirsiniz.

## 2. Formları Görüntüleme
- Oluşturduğunuz formları görüntülemek için "Formlar" modülüne gidin.
- Açılan sayfada oluşturduğunuz formların listesini görebilirsiniz.
- Her formun yanındaki "Görüntüle" butonuna tıklayarak formu görüntüleyebilir ve detaylı bilgilerini inceleyebilirsiniz.

## 3. Formları Düzenleme
- Oluşturduğunuz bir formu düzenlemek için "Formlar" modülüne gidin.
- Açılan sayfada oluşturduğunuz formların listesini görebilirsiniz.
- Düzenlemek istediğiniz formun yanındaki "Düzenle" butonuna tıklayın.
- Açılan sayfada form bilgilerini düzenleyebilir ve sorularını değiştirebilirsiniz.
- Tüm değişiklikleri yaptıktan sonra "Kaydet" butonuna tıklayarak formunuzu güncelleyebilirsiniz.
